...
//   // draw universe simulation in empty sprite
...
//     spr.drawString(timeClient.getFormattedTime(), 70, 55, 6);
//     spr.drawString(getFormattedDate(), 40, 100, 6);
...
//     if (data_age_min < 70) spr.drawString(outputString, 15, 145, 4);
